...
if (isset($_POST['submit'])) {
    ...
    //$insertQry = "INSERT INTO `posts`(`userID`, `post_title`, `post_text`, `create_at`, `update_at`) VALUES ('$userID', '$post_title', '$post_text', '$create_at', '$update_at')";
    $insertQry = "UPDATE `posts` SET `post_title`='$post_title',`post_text`='$post_text' where post_id = '$post_id'";
    ...
    if ($post_title && $post_text) {
        ...
        $post_error = "Please enter Post Title and Post Text";
    }
}
                ...
                <div class="card">
                    <form class="" method="post">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="post" name="post_title" value="<?php echo $row['post_title'] ?>">
                        </div>
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="post_text" id="post_text" cols="30"
                                      rows="10"  value=""><?php echo $row['post_text'] ?></textarea>
                        </div>
